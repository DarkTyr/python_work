...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.line_reg_0, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_reg_1, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_reg_2, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_reg_3, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_reg_4, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_reg_5, 5, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.but_read_reg_0.setText(_translate("MainWindow", "Read Reg0", None))
        self.but_read_reg_1.setText(_translate("MainWindow", "Read Reg1", None))
        self.but_read_reg_2.setText(_translate("MainWindow", "Read Reg2", None))
        self.but_read_reg_3.setText(_translate("MainWindow", "Read Reg3", None))
        self.but_read_reg_4.setText(_translate("MainWindow", "Read Reg4", None))
        self.but_read_reg_5.setText(_translate("MainWindow", "Read Reg5", None))
